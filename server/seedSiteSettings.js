...
const HOME_PORTFOLIO_META = [
  ...
  { id: 'modern-industrial-office', name: 'The Neutral Edit', location: 'Lower Parel, Mumbai', category: 'Commercial', serviceHref: '/services/commercial', desc: 'A skyline terrace redesigned as an intimate outdoor retreat — stone floors, teak ceilings and lush greenery under city skies.' },
